...
\begin{center}
\includegraphics[width=15cm]{images/cu_overview.png}
\end{center}
...
Percentage of sky coverage with Cumulus clouds. Higher coverage (or 'oktas') indicates increasingly thick and overdeveloped cumulus. Greater than 75% may be unsoarable. 30% is ideal.
